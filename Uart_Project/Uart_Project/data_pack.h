...
typedef union
{
	...
	{
		unsigned I2C0 : 1;
		unsigned I2C1 : 1; //1号电机CAN通讯故障
		unsigned I2C2 : 1;  //2号电机CAN通讯故障
		unsigned I2C3 : 1; //3号电机CAN通讯故障
		unsigned I2C4 : 1;  //4号电机CAN通讯故障
		unsigned I2C5 : 1;       //温度异常
		unsigned I2C_MOUTH : 1;  //5v电源异常
		unsigned CAN8 : 1;       //胸部can通讯异常
		unsigned KEY : 1;       //触摸开关
		unsigned POWER_5: 1;
		unsigned POWER_12: 1;
		unsigned TMP: 1;
